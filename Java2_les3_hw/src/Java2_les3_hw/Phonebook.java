...
public class Phonebook {
    ...
    public void add (String surname, String number){
        ...
        if (book.containsKey(surname)) {
            ...
            if (!numbers.contains(number)) {
                ...
                System.out.println(String.format("Добавить номер невозможно. Номер %s уже существует для фамилии %s", number, surname));
        }else {
    ...
    public List<String> get(String surname) {
        if (book.containsKey(surname)) {
            ...
            System.out.println(String.format("В справочнике ничего не найдено для фамилии %s", surname));
        }
        return null;
    }
}
